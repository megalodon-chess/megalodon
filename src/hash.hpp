...
namespace Hash {
    ...
    const unsigned short RANDS[256] = {   // Random numbers
    ...
    const unsigned char RANDC[256] = {
        184, 208, 42,  83,  17,  8,   177, 180, 215, 245, 210, 150, 51,  50,  89,  113,
        2,   62,  37,  84,  41,  126, 86,  68,  146, 51,  128, 195, 96,  203, 79,  188,
        219, 37,  56,  163, 43,  48,  233, 102, 116, 106, 197, 201, 2,   190, 3,   32,
        60,  167, 252, 159, 116, 132, 136, 42,  124, 36,  141, 61,  179, 238, 254, 222,
        58,  250, 190, 217, 99,  50,  27,  62,  207, 53,  243, 12,  225, 17,  156, 222,
        168, 199, 212, 242, 135, 160, 235, 207, 52,  38,  88,  100, 142, 137, 139, 95,
        107, 95,  55,  51,  36,  240, 123, 86,  45,  201, 146, 202, 55,  22,  184, 17,
        90,  103, 87,  117, 64,  51,  195, 249, 62,  216, 170, 124, 72,  34,  47,  109,
        46,  125, 197, 108, 25,  230, 215, 77,  144, 86,  238, 173, 37,  107, 123, 237,
        25,  107, 139, 212, 190, 63,  35,  1,   194, 6,   83,  95,  192, 82,  205, 85,
        2,   56,  242, 32,  37,  163, 253, 127, 192, 57,  168, 15,  13,  44,  59,  43,
        162, 65,  101, 216, 2,   64,  110, 63,  76,  18,  20,  140, 87,  125, 193, 197,
        218, 229, 109, 172, 38,  207, 89,  144, 187, 250, 128, 97,  64,  119, 124, 197,
        120, 208, 38,  242, 200, 180, 248, 237, 218, 181, 237, 244, 231, 104, 118, 66,
        47,  153, 88,  239, 147, 212, 106, 168, 32,  138, 16,  75,  52,  209, 180, 209,
        102, 93,  244, 155, 68,  49,  186, 30,  81,  182, 4,   158, 253, 73,  14,  152,
    };
