...
LMRFactor: type=spin, default=65, min=0, max=100, percent of lowest branches to prune. ONLY WORKS IF USING HASH TABLE
...
EvalImbalance: type=spin, default=100, min=0, max=1000, weight (percent) of imbalance eval.
